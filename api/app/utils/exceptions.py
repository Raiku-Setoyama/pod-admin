...
class NotFoundError(AppException):
    ...
    def __init__(self, resource: str, resource_id: UUID | str | None = None) -> None:
...
class OrderNotFoundError(NotFoundError):
    ...
    def __init__(self, order_id: UUID | str) -> None:
...
class ManufacturingDataNotReadyError(AppException):
    ...
    def __init__(self, pending_count: int | None = None) -> None:
