...
- Name: FEAT-0014: 受注元管理 >> AC-007: 受注元一覧ページにテーブルが正しいカラムヘッダーで表示される
- Location: /app/tests/admin-chat-sources.spec.ts:125:7
...
============================================================
    ...
    at /app/tests/admin-chat-sources.spec.ts:122:5
```
