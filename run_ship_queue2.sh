#!/usr/bin/env bash
# Sequential /ship queue (残り5件): #29 → #27 → #25 → #30 → #26
set -e
...
notify "🚀 /ship キュー再開: #29 → #27 → #25 → #30 → #26"

# 1. #29 商品マスター一覧にフィルター追加
...
notify "🎉 全タスク完了! #29→#27→#25→#30→#26 すべてPR作成済み"
echo ""
echo "=========================================="
echo "✅ 全5タスク完了!"
echo "=========================================="
